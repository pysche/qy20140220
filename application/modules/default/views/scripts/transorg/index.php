			...
			<tr>
				...
				<td>
					<a class='label label-success' href='<?php echo $this->url(array(
						...
						'action' => 'medicines',
						'trans_id' => $row->id
					), null, true);?>' data-target='trans_medicines' data-transport='modal'>设置目录</a>
				</td>
				<td>
...
<div class="modal fade" id='trans_medicines' data-role='modal'>
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body" id='trans_medicines_body'>
...
$(function () {
	$('#save_directory').unbind('click').bind('click', function () {
		var form = $('#trans_medicines_body form[name="list"]');
		var ids = [];
		var cbs = form.find(':checked').each(function () {
			var $this = $(this);
			ids.push($this.val());
		});
		var transId = form.find('#trans_id').val();
