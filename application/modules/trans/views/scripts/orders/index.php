  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a data-role='prepare' href="<?php echo $this->url(array(
        	'module' => $this->MODULE,
        	'controller' => $this->cName,
        	'action' => 'sprepare',
        	'id' => $id
        ), null, true);?>" data-transport='ajax' data-format='script' onclick="return confirm('确定？')" class="btn btn-info">开始备货</a>

         <a data-role='sent' href="<?php echo $this->url(array(
        	'module' => $this->MODULE,
        	'controller' => $this->cName,
        	'action' => 'ssent',
        	'id' => $id
        ), null, true);?>" data-transport='ajax' data-format='script' onclick="return confirm('确定？')" class="btn btn-primary">直接发货</a>
      </div>
    </div>
  </div>
</div>
