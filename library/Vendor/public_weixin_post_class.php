...
class Weixin
{
  ...
  {
    $url = 'https://mp.weixin.qq.com/cgi-bin/operate_appmsg?token='.$this->_token.'&lang=zh_CN&sub=list&type=10&subtype=3&t=wxm-appmsgs-list-new&pagesize=10000&pageidx=0&lang=zh_CN';
  ...
  {
    $url = 'https://mp.weixin.qq.com/cgi-bin/contactmanage?t=user/index&pagesize=10000&pageidx=0&type=0&groupid=0&token='.$this->_token.'&lang=zh_CN';
    $stream = $this->_html($url);
  ...
  {
    $url = 'https://mp.weixin.qq.com/cgi-bin/contactmanage?t=user/index&pagesize=10000&pageidx=0&type=0&groupid='.$gId.'&token='.$this->_token.'&lang=zh_CN';
    $stream = $this->_html($url);
  ...
  public function sendmesg($param)
  {
    ...
    $this->_header[1] = "Referer:https://mp.weixin.qq.com/cgi-bin/singlemsgpage?msgid=&source=&count=20000&t=wxm-singlechat&fromfakeid=".$param['fakeId']."&token=".$this->_token;
    $stream = $this->_html($url, $post);
  ...
  {
    $url = 'https://mp.weixin.qq.com/cgi-bin/message?t=message/list&count=200&day=7&token='.$this->_token;
